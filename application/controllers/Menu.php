...
class Menu extends CI_Controller
{
    ...
    public function submenuedit()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Change Failed!</div>');
            redirect('menu/submenu');
        } else {
            $data = array(
                'title' => $_POST['title'],
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Siiiippp!</div>');
            redirect('menu/submenu');
        }
    }
