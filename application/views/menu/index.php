                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="#" class="badge badge-success" data-toggle="modal" data-popup="tooltrip" data-placement="top" title="edit" data-target="#editMenu<?= $m['id']; ?>">Edit</a>
                                <a href="#" onclick="deleteMenu('<?= base_url('menu/hapusmenu/'). $m['id'] ?>')" class="badge badge-danger badge-sm tombol-hapus">Delete</a> 
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
